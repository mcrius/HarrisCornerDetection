...
//                System.out.println(diffx[x + (y * width)]);
...
//        int[] dfx = new int[diffx.length];
//        for (int i = 0; i < dfx.length; i++) {
//            dfx[i] = (int) Math.round(diffx[i]);
//
//        }
//        int[] dfy = new int[diffy.length];
//        for (int i = 0; i < dfy.length; i++) {
//            dfy[i] = (int) Math.round(diffy[i]);
//
//        }
...
//        }
        ...
        diffy = g.process();
//        for (int i = 0; i < dfy.length; i++) {
//            diffy[i] = (double) dfy[i];
//        }
        progress += width;
//        int[] diffxy = new int[diffxy.length];
//        for (int i = 0; i < dfxy.length; i++) {
//            dfxy[i] = (int) Math.round(diffxy[i]);
//
//        }

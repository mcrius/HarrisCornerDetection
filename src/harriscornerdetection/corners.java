...
public class corners extends JApplet {
    ...
    String fileNames[] = {"screw.png", "microphone.png", "screw.png", "drawing.png", "film.png"};
    ...
    Image im = new ToolkitImage(new FileImageSource("screw.png"));
...
//            image[i] = getImage(this.getCodeBase(), fileNames[i]);
        ...
        timer = new javax.swing.Timer(100, (ActionEvent evt) -> {
    ...
    private void processImage() {
        ...
        PixelGrabber gr = new PixelGrabber(image[imageNumber], 0, 0, width, height, orig, 0, width);
        try {
            gr.grabPixels();
